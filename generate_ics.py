...
<style>
 :root{{--ink:#12261a;--accent:#1a7f4b;--line:#e2e6e3}}
 *{{box-sizing:border-box}}
 body{{font:16px/1.5 system-ui,-apple-system,sans-serif;margin:0;padding:1.5rem;
   max-width:44rem;color:var(--ink)}}
 header{{border-bottom:3px solid var(--accent);padding-bottom:.9rem;margin-bottom:1.25rem}}
 .brand{{font-size:1.6rem;font-weight:700;letter-spacing:-.02em;margin:0}}
 .brand span{{color:var(--accent)}}
 .tag{{color:#5c6b62;margin:.15rem 0 0;font-size:.95rem}}
 h2{{font-size:1.05rem;margin:0 0 .2rem}}
 p.sub{{color:#5c6b62;margin:0 0 1.25rem;font-size:.95rem}}
 table{{border-collapse:collapse;width:100%}}
 td{{padding:.8rem .4rem;border-top:1px solid var(--line);vertical-align:middle}}
 .count{{color:#7a877f;font-size:.85rem}}
 .btn{{display:inline-block;padding:.42rem .75rem;margin:.15rem .15rem .15rem 0;
   background:var(--accent);color:#fff;text-decoration:none;border-radius:.35rem;
   font-size:.85rem;font-weight:500}}
 .btn.plain{{background:#eef1ef;color:#3c4a42}}
 .note,.warn{{background:#f4f7f5;padding:.8rem 1rem;border-radius:.4rem;
   font-size:.9rem;border-left:3px solid var(--accent)}}
 .warn{{background:#fff4e5;border-left-color:#d98324}}
 footer{{margin-top:2rem;padding-top:.9rem;border-top:1px solid var(--line);
   color:#7a877f;font-size:.82rem}}
</style>
<header>
  <p class=brand>Korf<span>Kal</span></p>
  <p class=tag>{html.escape(club)} Korfball — 2026-27 season</p>
</header>
...
<footer>Generated by KorfKal</footer>
</html>
"""
